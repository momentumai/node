...
function getURL (teamId) {
    return function (data) {
        return ds.query('Content', function (query) {
            return query.filter('content_id', data.contentId);
...
toplist.get = function (teamId, cats, now) {
    ...
    return ds.query('RealtimeContentModel', function (query, datastore) {
        query = query.filter('__key__', '>', datastore.key(
        ...
        query = query.order('__key__', {'descending': true});
