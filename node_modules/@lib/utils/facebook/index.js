var config = require('@config'),
    ...
    logger = require('@lib/logger')('utils/facebook'),
    redirectCodes = [10, 102, 104, 190, 200, 294],
    facebook = {};
...
facebook.get = function (endpoint, accessToken) {
    var url = 'https://graph.facebook.com/v2.7/' + endpoint;
    ...
    return new Promise(function (resolve, reject) {
        ...
        request.get(url, function (err, ignore, body) {
            ...
            if (res.error) {
                if (redirectCodes.indexOf(Number(res.error.code)) !== -1) {
